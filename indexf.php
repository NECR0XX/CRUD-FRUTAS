...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($count > 0) {
            $error = 'Já existe um produco com esse nome no carrinho.';
        } else {
    ...
    <div id="b">
        <button type="submit" name="submit" value="agendar">Comprar</button></br></br>
        <a href="listarf.php">Listar </a></br></br>
